  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="{{url("/profile/view")}}" class="d-block">{{$user->username}}</a>
        </div>
      </div>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            @if (($item->parent_id == '0'))
              <li class="nav-item menu-open">
                <a class="nav-link {{ (app('request')->route()->uri()== "{!! $item->url !!}") ? "nav-link active" : ""}}" class="nav-link">
                  <i class="{{$item->icon}}"></i>
                  <p>
                    {{$item->module_name}}
                ...
                @foreach ($dashboard as $itemIn)
                  <ul class="nav nav-treeview">
                    @if (($item->id == $itemIn->parent_id))
                      <li class="nav-item">
                        <a href="{!! $itemIn->url !!}" class="nav-link {{ (app('request')->route()->uri()== "{!! $itemIn->url !!}") ? "active" : ""}} ">
